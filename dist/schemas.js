...
export const ModelSchema = z
    ...
    .describe("Model to use. 'gemini-3-pro-image-preview' (Nano Banana Pro) for best quality and features, " +
...
export const AspectRatioSchema = z
    .enum(ASPECT_RATIOS)
    .optional()
    .describe("Aspect ratio of the generated image. Options: 1:1, 2:3, 3:2, 3:4, 4:3, 4:5, 5:4, 9:16, 16:9, 21:9. " +
...
export const ResolutionSchema = z
    .enum(RESOLUTIONS)
    .optional()
    .describe("Resolution of the generated image (Nano Banana Pro only). Options: 1K, 2K, 4K. " +
...
export const GenerateImageInputSchema = z
    ...
    prompt: z
        ...
        .describe("Text description of the image to generate. Be descriptive for better results. " +
    ...
    use_google_search: z
        ...
        .optional()
        .default(false)
        .describe("Enable Google Search grounding for real-time information (e.g., current weather, news). " +
...
export const EditImageInputSchema = z
    ...
    prompt: z
        ...
        .min(1, "Prompt cannot be empty")
        .max(10000, "Prompt too long (max 10000 characters)")
        .describe("Text description of the edit to make. Describe what to add, remove, or modify. " +
        "Be specific about the desired changes."),
    image_base64: z
        .string()
        .min(1, "Image data cannot be empty")
        .describe("Base64-encoded image data to edit. Do not include data URI prefix."),
    image_mime_type: z
        .string()
        .regex(/^image\/(png|jpeg|jpg|gif|webp)$/, "Invalid MIME type")
        .describe("MIME type of the image. Supported: image/png, image/jpeg, image/jpg, image/gif, image/webp"),
    model: ModelSchema,
    aspect_ratio: AspectRatioSchema,
    resolution: ResolutionSchema,
})
...
export const ComposeImagesInputSchema = z
    ...
    prompt: z
        ...
        .min(1, "Prompt cannot be empty")
        .max(10000, "Prompt too long (max 10000 characters)")
        .describe("Text description of how to compose/combine the images. " +
    ...
    images: z
        ...
        .describe("Array of images to use as references. Up to 14 images total: " +
    ...
    model: z
        ...
        .default(MODELS.NANO_BANANA_PRO)
        .describe("Model to use. Multi-image composition requires Nano Banana Pro (gemini-3-pro-image-preview)."),
    aspect_ratio: AspectRatioSchema,
    resolution: ResolutionSchema,
})
    .strict();
...
export const ListModelsInputSchema = z
    ...
    response_format: z
        ...
        .optional()
        .default("markdown")
        .describe("Output format: 'markdown' for human-readable or 'json' for machine-readable. Default: markdown"),
})
    .strict();
