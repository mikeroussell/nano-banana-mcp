...
import { MODELS, ModelInfo, AspectRatio, Resolution } from "./types.js";
import {
  GenerateImageInputSchema,
  EditImageInputSchema,
  ComposeImagesInputSchema,
  ListModelsInputSchema,
  type GenerateImageInput,
  type EditImageInput,
  type ComposeImagesInput,
...
const MODEL_INFO: ModelInfo[] = [
  {
    ...
    description:
      "State-of-the-art image generation and editing model. Optimized for professional asset production with advanced reasoning, high-fidelity text rendering, and up to 4K resolution.",
    features: [
  ...
  },
  {
    ...
    description:
      "Fast, low-latency image generation model. Great for quick experimentation, iteration, and high-volume generation.",
    features: [
